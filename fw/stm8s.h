...
/* Interrupt number */
enum {
  ISR_TLI            = (uint8_t)0,   /*!< Software interrupt */
  ISR_AWU            = (uint8_t)1,   /*!< Auto wake up from halt interrupt */
  ISR_CLK            = (uint8_t)2,   /*!< Clock controller interrupt */
  ISR_PORTA          = (uint8_t)3,   /*!< Port A external interrupts */
  ISR_PORTB          = (uint8_t)4,   /*!< Port B external interrupts */
  ISR_PORTC          = (uint8_t)5,   /*!< Port C external interrupts */
  ISR_PORTD          = (uint8_t)6,   /*!< Port D external interrupts */
  ISR_PORTE          = (uint8_t)7,   /*!< Port E external interrupts */

#if defined(STM8S208) || defined(STM8AF52Ax)
  ISR_CAN_RX         = (uint8_t)8,   /*!< beCAN RX interrupt */
  ISR_CAN_TX         = (uint8_t)9,   /*!< beCAN TX/ER/SC interrupt */
#endif /*STM8S208 or STM8AF52Ax */

#if defined(STM8S903) || defined(STM8AF622x)
  ISR_PORTF          = (uint8_t)8,   /*!< Port F external interrupts */
#endif /*STM8S903 or STM8AF622x */

  ISR_SPI            = (uint8_t)10,  /*!< SPI interrupt */
  ISR_TIM1_OVF       = (uint8_t)11,  /*!< TIM1 update/overflow/underflow/trigger/
                                         break interrupt*/
  ISR_TIM1_CAPCOM    = (uint8_t)12,  /*!< TIM1 capture/compare interrupt */

#if defined(STM8S903) || defined(STM8AF622x)
  ISR_TIM5_OVFTRI    = (uint8_t)13,  /*!< TIM5 update/overflow/underflow/trigger/
                                         interrupt */
  ISR_TIM5_CAPCOM    = (uint8_t)14,  /*!< TIM5 capture/compare interrupt */
#else
  ISR_TIM2_OVF       = (uint8_t)13,  /*!< TIM2 update /overflow interrupt */
  ISR_TIM2_CAPCOM    = (uint8_t)14,  /*!< TIM2 capture/compare interrupt */
#endif /*STM8S903 or STM8AF622x */

#if defined (STM8S208) || defined(STM8S207) || defined(STM8S007) || defined(STM8S105) || \
    defined(STM8S005) ||  defined (STM8AF62Ax) || defined (STM8AF52Ax) || defined (STM8AF626x)
  ISR_TIM3_OVF       = (uint8_t)15,  /*!< TIM3 update /overflow interrupt*/
  ISR_TIM3_CAPCOM    = (uint8_t)16,  /*!< TIM3 update /overflow interrupt */
#endif

#if defined(STM8S208) ||defined(STM8S207) || defined (STM8S007) || defined(STM8S103) || \
    defined(STM8S003) ||defined(STM8S903) || defined (STM8AF52Ax) || defined (STM8AF62Ax)
  ISR_UART1_TX       = (uint8_t)17,  /*!< UART1 TX interrupt */
  ISR_UART1_RX       = (uint8_t)18,  /*!< UART1 RX interrupt */
#endif /*STM8S208 or STM8S207 or STM8S007 or STM8S103 or STM8S003 or STM8S903 or STM8AF52Ax or STM8AF62Ax */
#if defined(STM8AF622x)
  ISR_UART4_TX       = (uint8_t)17,  /*!< UART4 TX interrupt */
  ISR_UART4_RX       = (uint8_t)18,  /*!< UART4 RX interrupt */
#endif /*STM8AF622x */

  ISR_I2C            = (uint8_t)19,  /*!< I2C interrupt */

#if defined(STM8S105) || defined(STM8S005) || defined(STM8AF626x)
  ISR_UART2_TX       = (uint8_t)20,  /*!< USART2 TX interrupt */
  ISR_UART2_RX       = (uint8_t)21,  /*!< USART2 RX interrupt */
#endif /*STM8S105 or STM8AF626x */

#if defined(STM8S208) || defined(STM8S207) || defined(STM8S007) || defined(STM8AF52Ax) || defined(STM8AF62Ax)
  ISR_UART3_TX       = (uint8_t)20,  /*!< USART3 TX interrupt */
  ISR_UART3_RX       = (uint8_t)21,  /*!< USART3 RX interrupt */
  ISR_ADC2           = (uint8_t)22,  /*!< ADC2 interrupt */
  ...
  ISR_ADC1           = (uint8_t)22,  /*!< ADC2 interrupt */
#endif /*STM8S105 or STM8S005 or STM8S003 or STM8S103 or STM8S903 or STM8AF626x or STM8AF622x */

#if defined(STM8S903) || defined(STM8AF622x)
  ISR_TIM6_OVFTRI    = (uint8_t)23,  /*!< TIM6 update/overflow/underflow/trigger/
                                         interrupt */
#else
  ISR_TIM4_OVF       = (uint8_t)23,  /*!< TIM4 update /overflow interrupt */
#endif /*STM8S903 or STM8AF622x */

  ISR_EEPROM_EEC     = (uint8_t)24  /*!< Flash interrupt */
};
